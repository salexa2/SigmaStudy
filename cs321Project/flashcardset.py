...
class flashcardset:
    ...
    def play(self,root):
       ...
       if(self.get_Size()>0):
           ...
           remove_card = customtkinter.CTkButton(play_frame, text = "", image = my_image,fg_color= "transparent",border_width=0, width = 25, height = 30, command = lambda:self.removeCard(root))
